                      ...
                      <?php
                       $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_user]'";
                        ...
                        <tr>
                          ...
                          <td ><a class="pull-right" style="margin-right: 5px;color:white;text-decoration-line: underline;font-weight: bolder;" href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>">Delete</a><a class="pull-right" style="margin-right: 5px;color:white;text-decoration-line: underline;font-weight: bolder;" href="edit-job-post.php?id=<?php echo $row['id_jobpost']; ?>">Edit</a><a class="pull-right" style="margin-right: 5px;color:white;text-decoration-line: underline;font-weight: bolder;" href="view-this-job-post.php?id=<?php echo $row['id_jobpost']; ?>">View</a></td>
